        ...
        <tbody>
          {employees.map((emp) => (
            <tr key={emp.employee_id}>
              <td><code style={{ color: 'var(--accent)', fontSize: '0.85rem' }}>{emp.employee_id}</code></td>
              <td>{emp.full_name}</td>
              ...
              <td>
                <button className="btn btn-danger" onClick={() => handleDelete(emp.employee_id)} disabled={deletingId === emp.employee_id}>
